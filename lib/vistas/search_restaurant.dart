...
class SearchRestaurant extends StatefulWidget {
  ...
  const SearchRestaurant({super.key, required this.busqueda});
...
class _SearchRestaurantState extends State<SearchRestaurant> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Center(child: Text("Resultados de busqueda")),
          ...
          child: ListView(
            children: [
              FutureBuilder<List<RestaurantModelo>>(
                  future: getSearchRestaurant(tokenUser, widget.busqueda),
                  builder: (context,
