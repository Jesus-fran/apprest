...
class RegistrandoUbicacion extends StatefulWidget {
  final String tokenUser;
  final RestaurantModelo info;
  final int id;
  const RegistrandoUbicacion({
    super.key,
  ...
  @override
  State<RegistrandoUbicacion> createState() => _RegistrandoUbicacionState();
}

class _RegistrandoUbicacionState extends State<RegistrandoUbicacion> {
  @override
      ...
      body: Padding(
        ...
        child: Center(
          child: FutureBuilder<RestaurantModelo>(
              future: updateUbicacion(widget.tokenUser, widget.info, widget.id),
